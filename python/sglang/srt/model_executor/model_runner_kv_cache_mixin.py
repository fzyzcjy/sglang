...
class ModelRunnerKVCacheMixin:
    ...
    def _init_pools(self: ModelRunner):
        ...
        if self.req_to_token_pool is None:
            ...
            elif config := mambaish_config(self):
        ...
        elif current_platform.is_out_of_tree() and not mambaish_config(self):
        ...
        elif self.use_mla_backend and not mambaish_config(self):
