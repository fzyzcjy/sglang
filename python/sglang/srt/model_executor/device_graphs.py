...
def create_device_graphs(model_runner: "ModelRunner") -> tuple[object, float]:
    ...
    if current_platform.is_out_of_tree():
        ...
        graph_runner = GraphRunnerCls(self)
    else:
        ...
        graph_runner = graph_runners[model_runner.device](self)
...
def create_piecewise_cuda_graphs(model_runner: "ModelRunner"):
    ...
    if model_runner.server_args.enable_breakable_cuda_graph:
        ...
        piecewise_cuda_graph_runner = BreakableCudaGraphRunner(self)
    else:
        piecewise_cuda_graph_runner = PiecewiseCudaGraphRunner(self)
