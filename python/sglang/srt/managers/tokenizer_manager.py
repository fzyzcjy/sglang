...
class TokenizerManager(TokenizerControlMixin):
        ...
        while True:
            try:
                ...
                if (
                    ...
                    self.pause_controller.abort_request(obj.rid)
    ...
    def create_abort_task(self, obj: GenerateReqInput):
        ...
        async def abort_request():
            ...
            if obj.is_single:
                ...
                for rid in obj.rid:
                    self.pause_controller.abort_request(rid)
    ...
    @staticmethod
    def _handle_update_weights_from_disk_req_output(
        ...
        if self.config.dp_size == 1:
            ...
            if len(self.model_update_tmp) == self.config.dp_size:
