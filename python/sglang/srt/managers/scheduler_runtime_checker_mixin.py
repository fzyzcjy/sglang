...
class SchedulerRuntimeCheckerMixin:
    ...
    @staticmethod
    def active_pool_idxs(
        self: "SchedulerPoolStatsObserver", *, last_batch, running_batch
    ) -> set:
    ...
    @staticmethod
    def session_held_tokens(
        self: "SchedulerPoolStatsObserver", *, last_batch, running_batch
    ) -> int:
        return self.tree_cache.session_held_tokens(
            SchedulerRuntimeCheckerMixin.active_pool_idxs(
                self, last_batch=last_batch, running_batch=running_batch
            )
        )

    @staticmethod
    def session_held_full_tokens(
        self: "SchedulerPoolStatsObserver", *, last_batch, running_batch
    ) -> int:
