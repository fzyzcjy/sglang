...
def ref_cutlass_fused_moe(
    ...
    assert torch.all(selected_experts_raw >= 0) and torch.all(selected_experts_raw < num_experts * ep_size)
    selected_experts = selected_experts_raw - num_experts * ep_rank
