...
class AttentionBackend(ABC):
    ...
    # Whether this backend builds per-request ragged verify metadata for the
    # token-keyed cuda-graph path (DSpark compact / real-N verify). The decode
    # cuda-graph runner gates ragged-verify graph admission on this. Default
    # False; the DSV4 family and trtllm_mha override it to True.
