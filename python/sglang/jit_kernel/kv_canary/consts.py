...
REAL_KV_SOURCE_FIELDS_PER_ENTRY: Final[int] = 6
...
REAL_KV_SOURCE_FIELD_COMPRESS_RATIO: Final[int] = 3
REAL_KV_SOURCE_FIELD_COMPRESS_RESIDUE: Final[int] = 4
REAL_KV_SOURCE_FIELD_HAS_SLOT_MAPPING: Final[int] = 5
