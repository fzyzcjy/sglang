...
class TestParseDiffThresholdRules:
    ...
    def test_single_float_shorthand(self) -> None:
        ...
        assert parse_diff_threshold_rules(["0.0085"], default_predicate="rel <= 0.001") == [
...
class TestResolvePredicate:
    ...
    def test_first_matching_pattern_wins(self) -> None:
        ...
        assert resolve_predicate("layer.expert.weight", rules, default_predicate="D") == "P1"
        assert resolve_predicate("layer.attn.weight", rules, default_predicate="D") == "P2"
