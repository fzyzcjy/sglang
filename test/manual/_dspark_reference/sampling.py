# Upstream source: deepspec/utils/sampling.py
# Copied verbatim for use as a self-contained parity oracle.
# deepspec.utils.sampling is not available in the SGLang CI environment;
# this shim provides the same functions so the reference markov_head.py
# can be imported without the DeepSpec package.
